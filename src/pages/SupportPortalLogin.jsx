...
import styles from "./SupportPortalLogin.module.css"
import { Link } from "react-router-dom"

export default function SupportPortalLogin() {
    ...
    <div className={styles.container}>
      <div className={styles.header}>
          <div className={styles.iconContainer}>
            <svg className={styles.headsetIcon} viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 1c-4.97 0-9 4.03-9 9v7c0 1.66 1.34 3 3 3h3v-8H5v-2c0-3.87 3.13-7 7-7s7 3.13 7 7v2h-4v8h3c1.66 0 3-1.34 3-3v-7c0-4.97-4.03-9-9-9z" />
            </svg>
          </div>
          <h1 className={styles.title}>Support Portal</h1>
          <p className={styles.subtitle}>Access your support dashboard</p>
        </div>
 ...
 <div className={styles.sectionHeader}>
        ...
        <div className={styles.footer}>
          <Link to="/adminLogin" className={styles.footerLink}>
